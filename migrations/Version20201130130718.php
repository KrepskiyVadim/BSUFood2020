 ...
 */
final class Version20201130130718 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user ADD phonenumber VARCHAR(13) NOT NULL, CHANGE roles roles JSON NOT NULL');
